...
public class AddAccountController extends HttpServlet {
  ...
  /*      try {
        PrintWriter out = response.getWriter(); */
             ...
             BigDecimal pi_AccountBalance= new BigDecimal(request.getParameter("AccountBalance"));
             BigDecimal pi_accountID= new BigDecimal(request.getParameter("AccountID"));
         ...
         RequestDispatcher rd =request.getRequestDispatcher("HibTest.jsp?message="+resultMessage); 
